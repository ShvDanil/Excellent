...
## Компонентная модель
*<ins>[Компонентная диагрмма решения](https://github.com/ShvDanil/Excellent/blob/main/readme_images/сomponent_diagram.png)</ins>*       
![Компонентная диагрмма](./readme_images/сomponent_diagram.png)

...
* **Система-обработчик запроса (Request Handler System).** Эта подсистема отвечает за получение запроса с данными с сервера и передачу всего контроллеру.
...
* **Подсистема база данных API (API Database), или место хранения данных (DataStorage).** Это база данных, содержащая информацию о пользователях, примеры тестов с ответами на них и результаты пользователей.

...
Для того, чтобы показать роль каждого пункта в общем решении, проведем их подробный анализ.
...
Сервисная шина, или ESP (Enterprise Service Bus) - связующее звено системы, обеспечивающее обмен информацией между клиентом и сервисом. Она отвечает за оркестровку и маршрутизацию данных, поступивших с пользовательской стороны. 

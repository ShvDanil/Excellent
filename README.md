...
Предлагаем проанализировать каждый пункт из предложенных и показать его роль в общем решении.
Для того, чтобы показать роль каждого пункта в общем решении, предлагаем 

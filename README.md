...
Доступ к базе данных API предоставляется с помощью самого нижнего слоя монолитной архитектуры ("Слой передачи данных"), с которого идет запрос в блок хранения данных (или базу данных API), где содержатся нужные таблицы с необходимыми данными для отработки запроса и предоставления ответа на него.

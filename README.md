...
Теперь посмотрим на то, как выглядит [монолитная архитектура](https://github.com/ShvDanil/Excellent/blob/main/readme_images/monolithic_architecture.png) и ее слои схематично:
